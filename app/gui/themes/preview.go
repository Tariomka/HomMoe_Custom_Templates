...
var (
	ColorEditorEdgeSelected = color.NRGBA{R: 0xFF, G: 0x9E, B: 0x2E, A: 0xFF} // selected connection
	...
	ColorEditorGridLine     = color.NRGBA{R: 0xF2, G: 0xEE, B: 0xF2, A: 0x0E}
	ColorEditorSnapGuide    = color.NRGBA{R: 0x50, G: 0xDC, B: 0x78, A: 0xB4} // green alignment guide
)
