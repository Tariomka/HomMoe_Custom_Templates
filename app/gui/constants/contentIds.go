...
var ContentIds = struct {
	...
	AbandonedCorpse:     models.SidMapping{Sid: interactableObjects.AbandonedCorpse, Name: "Abandoned Corpse"},
	...
	AlvarsEye:           models.SidMapping{Sid: interactableObjects.AlvarsEye, Name: "Alvar's Eye"},
	Arena:               models.SidMapping{Sid: interactableObjects.Arena, Name: "Arena"},
	ArmoryAutomaton:     models.SidMapping{Sid: interactableObjects.ArmoryAutomaton, Name: "Armory Automaton"},
	...
	CelestialSphere:     models.SidMapping{Sid: interactableObjects.CelestialSphere, Name: "Celestial Sphere"},
	...
	Circus:              models.SidMapping{Sid: interactableObjects.Circus, Name: "Circus"},
	CollegeOfWonder:     models.SidMapping{Sid: interactableObjects.CollegeOfWonder, Name: "College Of Wonder"},
	CrowNest:            models.SidMapping{Sid: interactableObjects.CrowNest, Name: "Crow Nest"},
	CrystalTrail:        models.SidMapping{Sid: interactableObjects.CrystalTrail, Name: "Crystal Trail"},
	...
	EnchantedScrollBox:  models.SidMapping{Sid: scrollObjects.EnchantedScrollBox, Name: "Enchanted Scroll"},
	EternalDragon:       models.SidMapping{Sid: interactableObjects.EternalDragon, Name: "Eternal Dragon"},
	FickleShrine:        models.SidMapping{Sid: interactableObjects.FickleShrine, Name: "Fickle Shrine"},
	FlatteringMirror:    models.SidMapping{Sid: interactableObjects.FlatteringMirror, Name: "Flattering Mirror"},
	Forge:               models.SidMapping{Sid: interactableObjects.Forge, Name: "Forge"},
	Fort:                models.SidMapping{Sid: interactableObjects.Fort, Name: "Fort"},
	...
	Gardener:            models.SidMapping{Sid: interactableObjects.Gardener, Name: "Gardener"},
	...
	HerosCrypt:          models.SidMapping{Sid: interactableObjects.HerosCrypt, Name: "Hero's Crypt"},
	HuntsmansCamp:       models.SidMapping{Sid: interactableObjects.HuntsmansCamp, Name: "Huntsman's Camp"},
	...
	JoustingRange:       models.SidMapping{Sid: interactableObjects.JoustingRange, Name: "Jousting Range"},
	...
	LegionsMemorial:     models.SidMapping{Sid: interactableObjects.LegionsMemorial, Name: "Legions Memorial"},
	...
	ManaWell:            models.SidMapping{Sid: interactableObjects.ManaWell, Name: "Mana Well"},
	Market:              models.SidMapping{Sid: interactableObjects.Market, Name: "Market"},
	Maze:                models.SidMapping{Sid: interactableObjects.Maze, Name: "Maze"},
	MercenaryGuild:      models.SidMapping{Sid: interactableObjects.MercenaryGuild, Name: "Mercenary Guild"},
	MereasShrine:        models.SidMapping{Sid: interactableObjects.MereasShrine, Name: "Merea's Shrine"},
	...
	MontyHall:           models.SidMapping{Sid: interactableObjects.MontyHall, Name: "Monty Hall"},
	MysteriousStone:     models.SidMapping{Sid: interactableObjects.MysteriousStone, Name: "Mysterious Stone"},
	MysticalTower:       models.SidMapping{Sid: interactableObjects.MysticalTower, Name: "Mystical Tower"},
	MythicScrollBox:     models.SidMapping{Sid: scrollObjects.MythicScrollBox, Name: "Mythic Scroll"},
	OrbObservatory:      models.SidMapping{Sid: interactableObjects.OrbObservatory, Name: "Orb Observatory"},
	OvergrownGrave:      models.SidMapping{Sid: interactableObjects.OvergrownGrave, Name: "Overgrown Grave"},
	PandoraBox:          models.SidMapping{Sid: resourceObjects.PandoraBox, Name: "Pandora Box"},
	PeasantCart:         models.SidMapping{Sid: interactableObjects.PeasantCart, Name: "Peasant Cart"},
	...
	PrismaticLair:       models.SidMapping{Sid: interactableObjects.PrismaticLair, Name: "Prismatic Lair"},
	Prison:              models.SidMapping{Sid: interactableObjects.Prison, Name: "Prison"},
	QuixsPath:           models.SidMapping{Sid: interactableObjects.QuixsPath, Name: "Quix's Path"},
	...
	ShadyDen:            models.SidMapping{Sid: interactableObjects.ShadyDen, Name: "Shady Den"},
	...
	StorageCrystals:     models.SidMapping{Sid: interactableObjects.CrystalStorage, Name: "Crystals Storage"},
	StorageDust:         models.SidMapping{Sid: interactableObjects.DustStorage, Name: "Dust Storage"},
	StorageGemstones:    models.SidMapping{Sid: interactableObjects.GemstoneStorage, Name: "Gemstones Storage"},
	...
	TreeOfAbundance:     models.SidMapping{Sid: interactableObjects.TreeOfAbundance, Name: "Tree Of Abundance"},
	TreeOfKnowledge:     models.SidMapping{Sid: interactableObjects.TreeOfKnowledge, Name: "Tree Of Knowledge"},
	TrialScales:         models.SidMapping{Sid: interactableObjects.TrialScales, Name: "Trial Scales"},
	...
	UnforgottenGrave:    models.SidMapping{Sid: interactableObjects.UnforgottenGrave, Name: "Unforgotten Grave"},
	University:          models.SidMapping{Sid: interactableObjects.University, Name: "University"},
	UnstableRuins:       models.SidMapping{Sid: interactableObjects.UnstableRuins, Name: "Unstable Ruins"},
	Village:             models.SidMapping{Sid: interactableObjects.Village, Name: "Village"},
	Watchtower:          models.SidMapping{Sid: interactableObjects.Watchtower, Name: "Watchtower"},
