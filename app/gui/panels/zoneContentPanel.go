...
type ZoneContentPanel struct {
	zcMines           *drivers.ZoneContentSection
	zcUtilities       *drivers.ZoneContentSection
	zcTreasures       *drivers.ZoneContentSection
	zcHires           *drivers.ZoneContentSection
	zcBanks           *drivers.ZoneContentSection
	zcHeroImprovement *drivers.ZoneContentSection

	tierSelector *components.SegmentButtonGroup
...
func NewZoneContentPanel(state *drivers.State) *ZoneContentPanel {
	panel := &ZoneContentPanel{
		zcMines:           drivers.NewZoneContentSection("Mines", constants.ContentItemGroup.Mines, 3, true),
		zcUtilities:       drivers.NewZoneContentSection("Utility Structures", constants.ContentItemGroup.UtilityStructures, 10, false),
		zcTreasures:       drivers.NewZoneContentSection("Treasures", constants.ContentItemGroup.Treasures, 10, false),
		zcHires:           drivers.NewZoneContentSection("Unit Recruitment", constants.ContentItemGroup.UnitRecruitment, 10, false),
		zcBanks:           drivers.NewZoneContentSection("Resource Banks", constants.ContentItemGroup.ResourceBanks, 10, false),
		zcHeroImprovement: drivers.NewZoneContentSection("Hero Improvement", constants.ContentItemGroup.HeroImprovementStructures, 10, false),
		tierSelector:      components.NewSegmentButtonGroup(tierLabels),
		state:             state,
	}
...
func (this *ZoneContentPanel) routeToSection(sid string, isMine bool) *drivers.ZoneContentSection {
	switch {
...
func (this *ZoneContentPanel) collectSectionRows() []models.ZoneContentRowSave {
	...
	gather := func(section *drivers.ZoneContentSection, isMine bool) {
