package template_variant_entity

import "github.com/Tariomka/hommoe_custom_templates/internal/entities/template_entity/template_common_entity"
...
type Connection struct {
	...
	PortalPlacementRulesFrom []template_common_entity.PlacementRule `json:"portalPlacementRulesFrom,omitempty"`
	PortalPlacementRulesTo   []template_common_entity.PlacementRule `json:"portalPlacementRulesTo,omitempty"`
}
