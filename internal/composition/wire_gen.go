...
func InitializeGuiHandler() handler_interfaces.IGuiHandler {
	...
	iRoadPolicyService := zones.NewRoadPolicyService(iRoadFactory)
	...
	iTemplateGenerator := template_generator.NewTemplateGenerator(generatorConfig, iZoneLabelProvider, iRoadPolicyService, iGenerationTuningFactory, iContentLimitProvider, iMandatoryContentProvider, iGameRulesProvider, iGladiatorArenaProvider, iTopologyProvider, iZoneLayoutProvider)
	...
	iTemplateHandler := handlers.NewTemplateHandler(iTemplateGenerator, iGeneratorConfigMapper, iMandatoryContentProvider, iConnectionEditorService, iZoneEditorService, iRoadPolicyService, iManualReapplyService, iFileService, iPreviewGeneratorService, iStateHandler)
