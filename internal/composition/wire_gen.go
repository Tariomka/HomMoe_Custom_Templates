...
func InitializeGuiHandler() handler_interfaces.IGuiHandler {
	...
	iTemplateGenerator := template_generator.NewTemplateGenerator(generatorConfig, iZoneLabelProvider, iGenerationTuningFactory, iTemplateMapper, iContentLimitProvider, iMandatoryContentProvider, iGameRulesProvider, iGladiatorArenaProvider, iTopologyProvider, iZoneLayoutProvider)
	...
	iFileService := file_service.NewFileService(iFileRepository, repositoriesIFileRepository, iFileRepository2, iEditorStateMapper)
