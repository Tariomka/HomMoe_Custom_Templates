...
func (this *State) layoutPreviewPanel(gtx layout.Context, theme *material.Theme) layout.Dimensions {
...
func (this *State) layoutPreviewCanvas(gtx layout.Context, theme *material.Theme, template *models.RmgTemplate) layout.Dimensions {
...
func (this *State) layoutPreviewLegend(gtx layout.Context, theme *material.Theme) layout.Dimensions {
...
func (this *State) savePreviewPNG() {
	template := this.lastTemplate
	if template == nil {
