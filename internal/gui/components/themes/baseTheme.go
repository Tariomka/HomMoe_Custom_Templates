...
var (
	...
	ColorAccent         = color.NRGBA{R: 0xC9, G: 0xA8, B: 0x4C, A: 0xFF}
	ColorAccentDim      = color.NRGBA{R: 0x8A, G: 0x6E, B: 0x30, A: 0xFF}
	ColorAccentBright   = color.NRGBA{R: 0xE0, G: 0xC0, B: 0x60, A: 0xFF}
	...
	ColorPrimaryButton  = color.NRGBA{R: 0x7A, G: 0x5A, B: 0x18, A: 0xFF}
)
