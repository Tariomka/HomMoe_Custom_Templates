...
type ZoneEditorDialog struct {
	...
	qualityDropdown *content.DropdownSelector
	castleDropdown  *content.DropdownSelector
...
func NewZoneEditorDialog(
	...
	dialog := &ZoneEditorDialog{
		...
		qualityDropdown:   content.NewDropdownSelector(connection_editor.QualityLabels),
		castleDropdown:    content.NewDropdownSelector([]string{"0", "1", "2", "3", "4"}),
	}
