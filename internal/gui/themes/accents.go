...
// Bonus / ban category dots (parity with the C# BonusEntry.DotBrush coding).
var (
...
// Spell-school accents (parity with the C# SpellPickerWindow palette).
var (
	ColorSchoolNeutral = color.NRGBA{R: 0xA8, G: 0xA4, B: 0xAC, A: 0xFF}
	ColorSchoolDay     = color.NRGBA{R: 0xD6, G: 0xC2, B: 0x7E, A: 0xFF}
	ColorSchoolNight   = color.NRGBA{R: 0x9B, G: 0x7E, B: 0xD4, A: 0xFF}
	ColorSchoolSpace   = color.NRGBA{R: 0x7E, G: 0xC9, B: 0xD0, A: 0xFF}
