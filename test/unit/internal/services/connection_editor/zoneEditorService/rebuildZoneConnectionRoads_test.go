...
func TestWhenZoneHasTwoConnections_KeepsRoadToExistingConnection(t *testing.T) {
	...
	// Act
	connection_editor.NewZoneEditorService().RebuildZoneConnectionRoads(zones, connections)
...
func TestWhenCastleCountShrank_DropsDanglingCastleRoads(t *testing.T) {
	...
	// Act
	connection_editor.NewZoneEditorService().RebuildZoneConnectionRoads(zones, nil)
