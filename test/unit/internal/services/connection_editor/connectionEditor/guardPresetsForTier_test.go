...
func TestWhenTierIsGiven_ReturnsMatchingGuardPresetRow(t *testing.T) {
	testCases := []struct {
		...
		{"WhenTierIsSilver_ReturnsSilverRow", connection_editor.ZoneTierSilver, [5]int{18000, 21000, 24000, 27000, 30000}},
		{"WhenTierIsGold_ReturnsGoldRow", connection_editor.ZoneTierGold, [5]int{36000, 42000, 48000, 54000, 60000}},
		{"WhenTierIsPlayerToPlayer_ReturnsPlayerToPlayerRow", connection_editor.ZoneTierPlayerToPlayer, [5]int{10000, 22000, 34000, 46000, 58000}},
	}
