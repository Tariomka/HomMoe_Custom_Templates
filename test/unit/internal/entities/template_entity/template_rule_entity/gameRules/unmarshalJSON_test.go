...
func TestWhenWinConditionsAreNested_DecodesNestedBlock(t *testing.T) {
	...
	expected := template_rule_entity.WinConditions{Classic: true, CityHold: true, CityHoldDays: 6}
	var rules template_rule_entity.GameRules
...
func TestWhenWinConditionsAreFlatSiblings_PopulatesWinConditions(t *testing.T) {
	...
	expected := template_rule_entity.WinConditions{Classic: true, CityHold: true, CityHoldDays: 9}
	var rules template_rule_entity.GameRules
...
func TestWhenFlatFieldIsMissingFromNestedBlock_FillsItFromFlatSibling(t *testing.T) {
	...
	expected := template_rule_entity.WinConditions{Classic: true, DesertionDay: 3}
	var rules template_rule_entity.GameRules
...
func TestWhenGladiatorArenaIsFlatSibling_MirrorsIntoWinConditions(t *testing.T) {
	...
	expected := template_rule_entity.WinConditions{GladiatorArena: true, GladiatorArenaCountDay: 3}
	var rules template_rule_entity.GameRules
...
func TestWhenScalarRuleFieldsProvided_DecodesWholeGameRules(t *testing.T) {
	...
	expected := template_rule_entity.GameRules{
		HeroCountMin:       4,
		HeroCountMax:       8,
...
func TestWhenFlatWinConditionDecodeFails_LeavesWinConditionsEmpty(t *testing.T) {
	...
	// Assert
	require.NoError(t, err)
	assert.Equal(t, template_rule_entity.WinConditions{}, rules.WinConditions)
}
