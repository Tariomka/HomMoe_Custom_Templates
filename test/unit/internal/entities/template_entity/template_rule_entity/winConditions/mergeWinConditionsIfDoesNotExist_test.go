...
func TestWhenDestinationIsEmpty_CopiesEverySourceField(t *testing.T) {
	t.Parallel()
	// Arrange
	destination := template_rule_entity.WinConditions{}
	source := template_rule_entity.WinConditions{Classic: true, CityHold: true, CityHoldDays: 9}
...
func TestWhenDestinationFieldIsSet_KeepsDestinationValue(t *testing.T) {
	t.Parallel()
	// Arrange
	destination := template_rule_entity.WinConditions{CityHoldDays: 6}
	source := template_rule_entity.WinConditions{CityHoldDays: 9}
...
func TestWhenSourceIsEmpty_LeavesDestinationUnchanged(t *testing.T) {
	t.Parallel()
	// Arrange
	destination := template_rule_entity.WinConditions{Classic: true, DesertionDay: 3}
	expected := destination

	// Act
	destination.MergeWinConditionsIfDoesNotExist(template_rule_entity.WinConditions{})
...
func TestWhenFieldsOverlapPartially_FillsOnlyMissingFields(t *testing.T) {
	...
	// Arrange
	destination := template_rule_entity.WinConditions{CityHoldDays: 6}
	source := template_rule_entity.WinConditions{CityHoldDays: 9, Desertion: true, DesertionDay: 3}
	expected := template_rule_entity.WinConditions{CityHoldDays: 6, Desertion: true, DesertionDay: 3}
...
func TestWhenSourceHasTournamentDaySlices_CopiesSlices(t *testing.T) {
	...
	// Arrange
	destination := template_rule_entity.WinConditions{}
	source := template_rule_entity.WinConditions{
		Tournament:             true,
...
func TestWhenSourceHasOnlyFieldsPresentInDestination_LeavesDestinationUnchanged(t *testing.T) {
	...
	destination := template_rule_entity.WinConditions{Classic: true, CityHoldDays: 6}
	expected := destination
	source := template_rule_entity.WinConditions{Classic: true, CityHoldDays: 9}
