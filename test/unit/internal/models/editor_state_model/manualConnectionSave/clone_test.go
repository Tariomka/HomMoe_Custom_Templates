...
type referenceFieldCase struct {
	read   func(save editor_state_model.ManualConnectionSave) any
	mutate func(save editor_state_model.ManualConnectionSave)
}
...
func referenceFieldCases() map[string]referenceFieldCase {
	return map[string]referenceFieldCase{
		"WhenRoadFlagIsMutated_SourceIsUnchanged": {
			read:   func(save editor_state_model.ManualConnectionSave) any { return *save.Connection.Road },
			mutate: func(save editor_state_model.ManualConnectionSave) { *save.Connection.Road = false },
		},
