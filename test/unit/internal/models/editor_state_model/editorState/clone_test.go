...
func contentRowFields() map[string]func(state *editor_state_model.EditorState) []editor_state_model.ZoneContentRow {
	return map[string]func(state *editor_state_model.EditorState) []editor_state_model.ZoneContentRow{
		"PlayerZoneContentRows": func(state *editor_state_model.EditorState) []editor_state_model.ZoneContentRow {
			return state.PlayerZoneContentRows
		},
		"LowestNeutralContentRows": func(state *editor_state_model.EditorState) []editor_state_model.ZoneContentRow {
			return state.LowestNeutralContentRows
		},
		"LowNeutralContentRows": func(state *editor_state_model.EditorState) []editor_state_model.ZoneContentRow {
			return state.LowNeutralContentRows
		},
		"MediumNeutralContentRows": func(state *editor_state_model.EditorState) []editor_state_model.ZoneContentRow {
			return state.MediumNeutralContentRows
		},
		"HighNeutralContentRows": func(state *editor_state_model.EditorState) []editor_state_model.ZoneContentRow {
			return state.HighNeutralContentRows
		},
		"HubZoneContentRows": func(state *editor_state_model.EditorState) []editor_state_model.ZoneContentRow {
...
func newContentRowState() editor_state_model.EditorState {
	newRow := func() []editor_state_model.ZoneContentRow {
